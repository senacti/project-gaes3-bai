              ...
              <a href="index.blade.php" class="logo"><img src="img/icono.PNG" alt=""></a>
                ...
                <form action="{{ route('register') }}" method="post">
                  ...
                  <div class="form-check d-flex justify-content-center mb-5">
                    ...
                    Estoy de acuerdo con los <a href="#!" class="text-body"><u>Términos y servicios</u></a>
                    </label>
                  </div>

                  <div class="d-flex justify-content-center">
                    <button type="submit"
                    class="btn btn-success btn-lg text-white font-weight-bold btn-custom">Registro</button>
                  </div>

                  <p class="text-center text-muted mt-5 mb-0">¿Ya tienes una cuenta? <a
                      href="{{ route('login') }}" class="fw-bold text-body"><u>Inicia sesión aquí</u></a></p>
